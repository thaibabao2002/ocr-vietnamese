...
from OCR_VN.utils import (get_rotate_crop_image, create_predictor, parse_args, build_post_process,
...
class TextSystem(object):
    ...
    def inference(self, img, cls=True):
        ...
        pair = []
        for i in range(len(filter_rec_res)):
            pair.append(filter_rec_res[i][0])
        return "\n".join(pair)
